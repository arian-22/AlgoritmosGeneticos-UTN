...
public class ViajeroHeuristico {
	...
	private static void ejecutarTSPHeurisica() {
		...
		do{
			...
			System.out.println();
			System.out.println("La ciudad actual del viajante es " + ciudades[posicionCiudadInArray].getNombre() + ". ");
			...
			distanciaTotalRecorrido += distanciaMasCerca;
			System.out.println("   /--\\ Distancia parcial: " + distanciaTotalRecorrido);
