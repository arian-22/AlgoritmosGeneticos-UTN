...
public class ViajeroExhaustivo {
	...
	private static void cargaDatos(Ciudad[] ciuds) {
		...
		dist[9]=new CiudadesDistancias("Buenos Aires","Paraná",480);
		dist[10]=new CiudadesDistancias("Buenos Aires","Córdoba",715);
		...
		dist[17]=new CiudadesDistancias("Buenos Aires","Neuquén",1158);
		...
		dist[9]=new CiudadesDistancias("San S. de Jujuy","Paraná",1138);
		dist[10]=new CiudadesDistancias("San S. de Jujuy","Córdoba",930);
		...
		dist[17]=new CiudadesDistancias("San S. de Jujuy","Neuquén",2200);
		...
		dist[9]=new CiudadesDistancias("Salta","Paraná",1105);
		dist[10]=new CiudadesDistancias("Salta","Córdoba",897);
		...
		dist[17]=new CiudadesDistancias("Salta","Neuquén",2082);
		...
		dist[9]=new CiudadesDistancias("San M de Tucuman","Paraná",798);
		dist[10]=new CiudadesDistancias("San M de Tucuman","Córdoba",590);
		...
		dist[17]=new CiudadesDistancias("San M de Tucuman","Neuquén",1860);
		...
		dist[9]=new CiudadesDistancias("Sgo. del Estero","Paraná",638);
		dist[10]=new CiudadesDistancias("Sgo. del Estero","Córdoba",430);
		...
		dist[17]=new CiudadesDistancias("Sgo. del Estero","Neuquén",1567);
		...
		dist[9]=new CiudadesDistancias("Formosa","Paraná",744);
		dist[10]=new CiudadesDistancias("Formosa","Córdoba",1043);
		...
		dist[17]=new CiudadesDistancias("Formosa","Neuquén",2060);
		...
		dist[9]=new CiudadesDistancias("Resistencia","Paraná",576);
		dist[10]=new CiudadesDistancias("Resistencia","Córdoba",875);
		...
		dist[17]=new CiudadesDistancias("Resistencia","Neuquén",2012);
		...
		dist[9]=new CiudadesDistancias("Santa Fe","Paraná",31);
		dist[10]=new CiudadesDistancias("Santa Fe","Córdoba",330);
		...
		dist[17]=new CiudadesDistancias("Santa Fe","Neuquén",1347);
		...
		dist[9]=new CiudadesDistancias("Corrientes","Paraná",590);
		dist[10]=new CiudadesDistancias("Corrientes","Córdoba",898);
		...
		dist[17]=new CiudadesDistancias("Corrientes","Neuquén",1989);
		...
		dist[9]=new CiudadesDistancias("Posadas","Paraná",820);
		dist[10]=new CiudadesDistancias("Posadas","Córdoba",1213);
		...
		dist[17]=new CiudadesDistancias("Posadas","Neuquén",2198);
		...
		dist[0]=new CiudadesDistancias("Paraná","Buenos Aires",480);
		dist[1]=new CiudadesDistancias("Paraná","Salta",1105);
		dist[2]=new CiudadesDistancias("Paraná","San M de Tucuman",798);
		dist[3]=new CiudadesDistancias("Paraná","Sgo. del Estero",638);
		dist[4]=new CiudadesDistancias("Paraná","Formosa",744);
		dist[5]=new CiudadesDistancias("Paraná","Resistencia",576);
		dist[6]=new CiudadesDistancias("Paraná","Santa Fe",31);
		dist[7]=new CiudadesDistancias("Paraná","Corrientes",590);
		dist[8]=new CiudadesDistancias("Paraná","Posadas",820);
		dist[9]=new CiudadesDistancias("Paraná","San S. de Jujuy",1138);
		dist[10]=new CiudadesDistancias("Paraná","Córdoba",361);
		dist[11]=new CiudadesDistancias("Paraná","La Rioja",796);
		dist[12]=new CiudadesDistancias("Paraná","San Juan",861);
		dist[13]=new CiudadesDistancias("Paraná","San Luis",656);
		dist[14]=new CiudadesDistancias("Paraná","Catamarca",801);
		dist[15]=new CiudadesDistancias("Paraná","Mendoza",916);
		dist[16]=new CiudadesDistancias("Paraná","Santa Rosa",841);
		dist[17]=new CiudadesDistancias("Paraná","Neuquén",1378);
		dist[18]=new CiudadesDistancias("Paraná","Viedma",1435);
		dist[19]=new CiudadesDistancias("Paraná","Rawson",1696);
		dist[20]=new CiudadesDistancias("Paraná","Rio Gallegos",2876);
		dist[21]=new CiudadesDistancias("Paraná","Ushuaia",3469);
		ciuds[10].setDistancias(dist);
		//cargar distancias cordoba
		dist[0]=new CiudadesDistancias("Córdoba","Buenos Aires",715);
		dist[1]=new CiudadesDistancias("Córdoba","Salta",897);
		dist[2]=new CiudadesDistancias("Córdoba","San M de Tucuman",590);
		dist[3]=new CiudadesDistancias("Córdoba","Sgo. del Estero",430);
		dist[4]=new CiudadesDistancias("Córdoba","Formosa",1043);
		dist[5]=new CiudadesDistancias("Córdoba","Resistencia",875);
		dist[6]=new CiudadesDistancias("Córdoba","Santa Fe",330);
		dist[7]=new CiudadesDistancias("Córdoba","Corrientes",898);
		dist[8]=new CiudadesDistancias("Córdoba","Posadas",1231);
		dist[9]=new CiudadesDistancias("Córdoba","Paraná",361);
		dist[10]=new CiudadesDistancias("Córdoba","San S. de Jujuy",930);
		dist[11]=new CiudadesDistancias("Córdoba","La Rioja",435);
		dist[12]=new CiudadesDistancias("Córdoba","San Juan",500);
		dist[13]=new CiudadesDistancias("Córdoba","San Luis",420);
		dist[14]=new CiudadesDistancias("Córdoba","Catamarca",440);
		dist[15]=new CiudadesDistancias("Córdoba","Mendoza",670);
		dist[16]=new CiudadesDistancias("Córdoba","Santa Rosa",600);
		dist[17]=new CiudadesDistancias("Córdoba","Neuquén",1137);
		dist[18]=new CiudadesDistancias("Córdoba","Viedma",1194);
		dist[19]=new CiudadesDistancias("Córdoba","Rawson",1455);
		dist[20]=new CiudadesDistancias("Córdoba","Rio Gallegos",3635);
		dist[21]=new CiudadesDistancias("Córdoba","Ushuaia",3228);
		...
		dist[9]=new CiudadesDistancias("La Rioja","Paraná",796);
		dist[10]=new CiudadesDistancias("La Rioja","Córdoba",435);
		...
		dist[17]=new CiudadesDistancias("La Rioja","Neuquén",1472);
		...
		dist[9]=new CiudadesDistancias("San Juan","Paraná",861);
		dist[10]=new CiudadesDistancias("San Juan","Córdoba",500);
		...
		dist[17]=new CiudadesDistancias("San Juan","Neuquén",1022);
		...
		dist[9]=new CiudadesDistancias("San Luis","Paraná",656);
		dist[10]=new CiudadesDistancias("San Luis","Córdoba",420);
		...
		dist[17]=new CiudadesDistancias("San Luis","Neuquén",883);
		...
		dist[9]=new CiudadesDistancias("Catamarca","Paraná",801);
		dist[10]=new CiudadesDistancias("Catamarca","Córdoba",440);
		...
		dist[17]=new CiudadesDistancias("Catamarca","Neuquén",1588);
		...
		dist[9]=new CiudadesDistancias("Mendoza","Paraná",916);
		dist[10]=new CiudadesDistancias("Mendoza","Córdoba",670);
		...
		dist[17]=new CiudadesDistancias("Mendoza","Neuquén",855);
		...
		dist[9]=new CiudadesDistancias("Santa Rosa","Paraná",841);
		dist[10]=new CiudadesDistancias("Santa Rosa","Córdoba",600);
		...
		dist[17]=new CiudadesDistancias("Santa Rosa","Neuquén",537);
		...
		dist[0]=new CiudadesDistancias("Neuquén","Buenos Aires",1158);
		dist[1]=new CiudadesDistancias("Neuquén","Salta",2082);
		dist[2]=new CiudadesDistancias("Neuquén","San M de Tucuman",1860);
		dist[3]=new CiudadesDistancias("Neuquén","Sgo. del Estero",1567);
		dist[4]=new CiudadesDistancias("Neuquén","Formosa",2060);
		dist[5]=new CiudadesDistancias("Neuquén","Resistencia",2012);
		dist[6]=new CiudadesDistancias("Neuquén","Santa Fe",1347);
		dist[7]=new CiudadesDistancias("Neuquén","Corrientes",1989);
		dist[8]=new CiudadesDistancias("Neuquén","Posadas",2198);
		dist[9]=new CiudadesDistancias("Neuquén","Paraná",1378);
		dist[10]=new CiudadesDistancias("Neuquén","Córdoba",1137);
		dist[11]=new CiudadesDistancias("Neuquén","La Rioja",1472);
		dist[12]=new CiudadesDistancias("Neuquén","San Juan",1022);
		dist[13]=new CiudadesDistancias("Neuquén","San Luis",883);
		dist[14]=new CiudadesDistancias("Neuquén","Catamarca",1588);
		dist[15]=new CiudadesDistancias("Neuquén","Mendoza",855);
		dist[16]=new CiudadesDistancias("Neuquén","Santa Rosa",537);
		dist[17]=new CiudadesDistancias("Neuquén","San S. de Jujuy",2200);
		dist[18]=new CiudadesDistancias("Neuquén","Viedma",660);
		dist[19]=new CiudadesDistancias("Neuquén","Rawson",750);
		dist[20]=new CiudadesDistancias("Neuquén","Rio Gallegos",1930);
		dist[21]=new CiudadesDistancias("Neuquén","Ushuaia",2523);
		...
		dist[9]=new CiudadesDistancias("Viedma","Paraná",1435);
		dist[10]=new CiudadesDistancias("Viedma","Córdoba",1194);
		...
		dist[17]=new CiudadesDistancias("Viedma","Neuquén",660);
		...
		dist[9]=new CiudadesDistancias("Rawson","Paraná",1696);
		dist[10]=new CiudadesDistancias("Rawson","Córdoba",1455);
		...
		dist[17]=new CiudadesDistancias("Rawson","Neuquén",750);
		...
		dist[9]=new CiudadesDistancias("Rio Gallegos","Paraná",2876);
		dist[10]=new CiudadesDistancias("Rio Gallegos","Córdoba",2635);
		...
		dist[17]=new CiudadesDistancias("Rio Gallegos","Neuquén",1930);
		...
		dist[9]=new CiudadesDistancias("Ushuaia","Paraná",3469);
		dist[10]=new CiudadesDistancias("Ushuaia","Córdoba",3228);
		...
		dist[17]=new CiudadesDistancias("Ushuaia","Neuquén",2523);
